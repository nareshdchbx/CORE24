...
lgnpage= new UAT_CreateAccountFunc(d);
	...
	public void testcase1(String pswd,String Lname, String dob,String sex,String addrl1, String ct,  String st,	String zip1,String elig,String enrlmnt,String newmem,String db1, String gndr1,String adr1, String cti1,String sta1, String zpc1,String enrlt21,String db3,String gndr3,String enrlt3,String db4, String gndr4,String enrlt4,String rltn23,String rltn24,String rltn25,String rltn26,String rltn27,String rltn,String incmtyp1,String amt1,String freq1,String stdate1,String incmtyp,String empname,String strt,String citi,String ste,String zpcd,String amt,String freq,String stdate) throws Exception {
		...
		String ssn3="6"+BusinessMethods.getRandomNumber(8);
		
		String temp2=BusinessMethods.getDynamicStr();
		String f4name=temp2;
		
		String ssn4="7"+BusinessMethods.getRandomNumber(8);
	...
	secpage.filing_ans1();
		...
		groupmembers_app.diffadd22(f1name,Lname,db1,gndr1,adr1,cti1,sta1,zpc1);
	 ...
	 @DataProvider (name="testcase")
	  ...
	  public Object[][] reg() throws Exception
	  {
		    ...
		    Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\core24.xlsx","test12", 1,43);
		    return (testObjArray);
