...
lgnpage= new UAT_CreateAccountFunc(d);
	...
	public void testcase1(String pswd,String Lname,String dob,String sex,String addrl1,String ct,String st,String zip1,String elig,String enrlmnt,String plan,String date,String benefits,String newmem,String db2,String gndr2,String enrlt1,String rltn,String incmtyp4,String amt4,String freq4,String stdate4,String incmtyp,String empname,String strt,String citi,String ste,String zpcd,String amt,String freq,String stdate,String incmtyp1,String amt1,String freq1,String stdate1) throws Exception {
		
		String temp=BusinessMethods.getDynamicStr();
		String uname=temp+"@gmail.com";
		
		String Fname=temp;
		String ssn="8"+BusinessMethods.getRandomNumber(8);
	...
	secpage.filing_ans1();
		...
		income_details.fillin4(incmtyp4,amt4,freq4,stdate4);
	 ...
	 @DataProvider (name="testcase")
	  ...
	  public Object[][] reg() throws Exception
	  {
		  ...
		  Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\core24.xlsx","Sheet2", 1,35);
		    return (testObjArray);
