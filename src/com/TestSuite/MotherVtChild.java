		...
		lgnpage= new UAT_CreateAccountFunc(d);
			...
			public void testcase1(String pswd,String Lname,String dob,String sex, String addrl1,  String ct,  String st,String zip1,String elig,String enrlmnt,String newmem,String db1, String gndr1,String enrlt1,String rltn,String incmtyp1,String amt1,String freq1,String stdate1) throws Exception {
	 ...
	 @DataProvider (name="testcase")
	  ...
	  public Object[][] reg() throws Exception
	  {
		   ...
		   Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\core24.xlsx","test20", 1,19);
