...
lgnpage= new UAT_CreateAccountFunc(d);
	...
	public void testcase1(String pswd,String Lname,String dob,String sex,String addrl1,String ct,String st,String zip1,String elig,String enrlmnt,String newmem,String db1,String gndr1,String enrlt1,String db2, String gndr2,String adr2, String cti2,String sta2, String zpc2,String enrlt2,String rltn26,String rltn27,String rltn,String incmtyp1,String amt1,String freq1,String stdate1,String incmtyp2,String amt2,String freq2,String stdate2,String incmtyp,String empname,String strt,String citi,String ste,String zpcd,String amt,String freq,String stdate) throws Exception {
...
secpage.filing_ans1();
	 ...
	 spage.click();
		...
		groupmembers_app.diffadd4(f2name,Lname,db2,gndr2,adr2,cti2,sta2,zpc2);
	 ...
	 @DataProvider (name="testcase")
	  ...
	  public Object[][] reg() throws Exception
	  {
		    ...
		    Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\core24.xlsx","test17", 1,41);
		    return (testObjArray);
