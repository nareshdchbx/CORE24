...
import com.utilities.LoggerClass;
	...
	lgnpage= new UAT_CreateAccountFunc(d);
		...
		public void testcase1(String pswd,String Lname, String dob,String sex,String addrl1,  String ct,  String st,String zip1,String elig,String enrlmnt,String ctzn,String newmem,String db2, String gndr2,String enrlmnt1,String ctzn1,String newmem1,String db3, String gndr3,String enrlmnt2,
				String ctzn2,String rltn26,String rltn27,String rltn,String incmtyp,String empname,String strt,String citi,String ste,String zpcd,String amt,String freq,String stdate) throws Exception {
			...
			String alienno="7"+BusinessMethods.getRandomNumber(8);
			
			
			
			String alienno1="6"+BusinessMethods.getRandomNumber(8);
			
			
			
			String alienno2="6"+BusinessMethods.getRandomNumber(8);
		...
		secpage.filing_ans1();
			...
			refugee_moreabtu.fillin2( ssn2, enrlmnt2,ctzn2);
		 ...
		 @DataProvider (name="testcase")
		  ...
		  public Object[][] reg() throws Exception
		  {
			    ...
			    Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\core24.xlsx","test4", 1,33);
			    return (testObjArray);
