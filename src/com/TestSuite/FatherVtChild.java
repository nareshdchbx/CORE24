...
public class FatherVtChild extends BaseClass{
...
lgnpage= new UAT_CreateAccountFunc(d);
	...
	public void testcase1(String pswd,String Lname, String dob,String sex,String addrl1,  String ct,  String st,String zip1,String elig,String db1, String gndr1,String rltn,String incmtyp1,String amt1,String freq1,String stdate1) throws Exception {
		...
		lgnpage.CreateAccount1(uname,pswd,Fname,Lname,dob,sex);
	...
	secpage.filing_ans1();
		...
		groupmembers_app.filliny(f1name,Lname,db1,gndr1);
	 ...
	 @DataProvider (name="testcase")
	  ...
	  public Object[][] reg() throws Exception
	  {
		    ...
		    Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\core24.xlsx","test19", 1,16);
		    return (testObjArray);
