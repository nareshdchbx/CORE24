...
public class ChildlessAdult_IncomeUnderMedicaid_HavingMEC extends BaseClass{
	...
	public void testcase1(String pswd,String lname, String dob,String sex,String addrl1, String ct,String st, 
	String zip1,String elig,String enrlmnt,String plan,String date,String benefits,String newmem,String incmtyp,String empname,String strt,String citi,String ste,String zpcd,String amt,String freq,String stdate) throws Exception{
		
		//String LastName=confMngr.getProperty("LastName");
	...
	@DataProvider (name="testcase")
	  ...
	  public Object[][] reg() throws Exception
	  {
		 ...
		 Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\core24.xlsx","test1", 1,23);
		    return (testObjArray);
